...
{
    [Expression(Operators.Divide, typeof(Creator))]
    class DivideExpression : DualityExpression
    {
        public DivideExpression(Expression exp1, Expression exp2)
            : base(exp1, exp2)
        {
        ...
        class Creator : ExpressionCreator
        {
            ...
            public override Expression Create(Expression[] parameters)
            {
                ...
                return new DivideExpression(parameters[0], parameters[1]);
            }
