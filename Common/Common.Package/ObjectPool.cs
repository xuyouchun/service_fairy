...
namespace Common.Package
{
        ...
        where T : class
    {
        ...
        /// 申请一个对象
        /// </summary>
        /// <param name="timeoutMillseconds">当对象列表为空时，最多等待的时间</param>
        /// <param name="waitForExit"></param>
        /// <returns></returns>
        public T Accquire(int timeoutMillseconds = -1, WaitHandle waitForExit = null)
        {
            if (!_Stragety.Wait(1, timeoutMillseconds, waitForExit))
                return null;
        ...
        /// <param name="waitForExit"></param>
        /// <returns></returns>
        public T[] AccquireRange(int count, TimeSpan timeout, WaitHandle waitForExit = null)
        {
        ...
        /// <param name="waitForExit"></param>
        /// <returns></returns>
        public T[] AccquireRange(int count, int timeoutMillseconds = -1, WaitHandle waitForExit = null)
        {
            Contract.Requires(count > 0);

            if (!_Stragety.Wait(count, timeoutMillseconds, waitForExit))
                return null;
        ...
        /// <param name="waitForExit"></param>
        /// <returns></returns>
        public IDisposable AccquireRange(int count, out T[] objs, int timeoutMillseconds = -1, WaitHandle waitForExit = null)
        {
            objs = AccquireRange(count, timeoutMillseconds, waitForExit);
        ...
        /// <param name="waitForExit"></param>
        /// <returns></returns>
        public IDisposable AccquireRange(int count, out T[] objs, TimeSpan timeout, WaitHandle waitForExit = null)
        {
            objs = AccquireRange(count, timeout, waitForExit);
            return new ReleaseRangeHelper(this, objs);
        }
        ...
        class ReleaseRangeHelper : IDisposable
        {
