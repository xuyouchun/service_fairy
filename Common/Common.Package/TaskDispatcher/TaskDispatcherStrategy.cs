...
namespace Common.Package.TaskDispatcher
{
        ...
        where TTask : class, ITask
    {
        ...
        /// <param name="taskSemaphore"></param>
        /// <param name="threadPriority"></param>
        public TaskDispatcherStrategy(ITaskSemaphore taskSemaphore = null, ITaskQueue<TTask> taskQueue = null, ThreadPriority threadPriority = ThreadPriority.Normal)
        {
            ...
            _DispatchThread.Priority = threadPriority;
        }
        ...
        /// <param name="taskQueue">任务队列</param>
        /// <param name="threadPriority"></param>
        public TaskDispatcherStrategy(int maxRunningCount, ITaskQueue<TTask> taskQueue = null, ThreadPriority threadPriority = ThreadPriority.Normal)
            : this(new TaskSemaphore(maxRunningCount), taskQueue, threadPriority)
        {
