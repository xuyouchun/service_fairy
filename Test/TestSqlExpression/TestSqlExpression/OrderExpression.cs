...
namespace Common.Data.UnionTable.SqlExpressions
{
    ...
    /// 排序表达式
    /// </summary>
    public class OrderExpression : SqlExpression, ISqlExpressionWithFieldName
    {
        public OrderExpression(OrderExpressionItem[] items)
        {
        ...
        {
            return Items.SelectFromArray(item => item.FieldName);
        }
