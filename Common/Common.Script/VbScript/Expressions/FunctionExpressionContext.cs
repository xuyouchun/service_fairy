...
{
    class FunctionExpressionContext: IExpressionContext
    {
        public FunctionExpressionContext(IExpressionContext context, IExpressionContext globalContext)
        {
            _Context = context;
        ...
        public Value GetValue(string name)
        {
            ...
            return _GlobalContext.GetValue(name);
        }
