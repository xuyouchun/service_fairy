...
{
    [Expression(Operators.NotEquals, typeof(Creator))]
    class NotEqualsExpression : DualityExpression
    {
        public NotEqualsExpression(Expression exp1, Expression exp2)
            : base(exp1, exp2)
        {
        ...
        class Creator : ExpressionCreator
        {
            ...
            public override Expression Create(Expression[] parameters)
            {
                ...
                return new NotEqualsExpression(parameters[0], parameters[1]);
            }
